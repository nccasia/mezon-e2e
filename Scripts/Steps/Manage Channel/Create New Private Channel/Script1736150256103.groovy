...
for (int i = 0; i < 15; i++) {
	...
	if(newChannelElementText == newChannelName) {
		...
		String privateChannelSVG = CustomKeywords.'mezon.ConvertFile.toString'('\\Data Files\\Svg\\Private Channel.svg')
		
		if(newChannelElementInnerHTML.contains(privateChannelSVG)) {
