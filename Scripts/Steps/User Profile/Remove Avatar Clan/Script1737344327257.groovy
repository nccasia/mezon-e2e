...
WebUI.click(findTestObject('Object Repository/User Profile/Change Clan Nickname/button_Profile Option'))

WebUI.click(findTestObject('User Profile/Remove Avatar Clan/button_Clan Profile'))

WebElement previewAvatarElement = WebUI.findWebElement(findTestObject('Object Repository/User Profile/Remove Avatar Clan/img_Preview Avatar'))

String previewAvatarSrc = previewAvatarElement.getAttribute('src')

WebUI.click(findTestObject('User Profile/Remove Avatar Clan/button_Remove Avatar'))
...
for (int i = 0; i < 15; i++) {
    previewAvatarElement = WebUI.findWebElement(findTestObject('Object Repository/User Profile/Remove Avatar Clan/img_Preview Avatar'))
...
WebElement avatarInMessageItemElement = WebUI.findWebElement(findTestObject("Object Repository/User Profile/Remove Avatar Clan/img_Avatar in Message Item"))

String avatarInMessageItemSrc = avatarInMessageItemElement.getAttribute("src")

avatarInMessageItemSrc = splice(avatarInMessageItemSrc, "/plain/")

if(!avatarInMessageItemSrc.equals(previewAvatarSrcChanged)) {
	WebUI.takeScreenshot()
	KeywordUtil.markFailedAndStop('Not remove avatar')
}
